...
struct ContactImpact {
    state::Entity Entity{state::Null}; // Owning entity of the struck body.
    state::Entity ColliderEntity{state::Null}; // The collider node of this body that was struck.
    state::Entity Other{state::Null}; // The body that struck it.
    state::Entity OtherColliderEntity{state::Null}; // The collider node of the other body that did the striking.
...
struct SustainedContactSide {
    state::Entity Entity{state::Null}; // The body this side describes.
    // Collider node for this sub-shape.
    state::Entity ColliderEntity{state::Null};
