...
std::expected<std::vector<std::byte>, std::string> EncodeImageRgba8ForMime(gltf::MimeType, std::span<const std::byte> rgba8, uint32_t width, uint32_t height, int jpeg_quality, std::string_view name);
