...
void main() {
    ...
    const vec3 hint_color = is_object_mode ? bone_color : bone_wire_color(load_bone_instance_state(draw));
    const vec3 state_color = hint_color * hint_color * 0.1; // Blender's bone_hint_color_shade
