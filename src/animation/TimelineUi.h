...
std::optional<action::Action> RenderAnimationTimeline(const TimelineRange &, const TimelinePlayback &, const AnimationTimelineView &, const TimelineNavigation &, const Animations &, std::span<const float> keyframes, const AnimationIcons &, bool &scrubbing);
